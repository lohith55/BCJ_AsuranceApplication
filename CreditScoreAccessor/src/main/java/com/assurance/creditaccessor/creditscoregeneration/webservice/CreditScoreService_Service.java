 ...
 * 2016-10-06T16:33:09.670-05:00
 * Generated source version: 2.7.3
 * 
 */
@WebServiceClient(name = "CreditScoreService", 
                  wsdlLocation = "file:/C:/BCJ_MAY16/Develop/CoreJAVA/NeonWorkspace/CreditScoreAccessor/src/main/resources/test.wsdl",
...
public class CreditScoreService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJ_MAY16/Develop/CoreJAVA/NeonWorkspace/CreditScoreAccessor/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CreditScoreService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJ_MAY16/Develop/CoreJAVA/NeonWorkspace/CreditScoreAccessor/src/main/resources/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
