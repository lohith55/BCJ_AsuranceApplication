 ...
 * 2016-10-05T14:48:42.520-05:00
 * Generated source version: 2.7.3
 * 
 */
@WebServiceClient(name = "ServiceProvider", 
                  wsdlLocation = "file:/C:/BCJ_MAY16/Develop/Repository/BCJ_AsuranceApplication/BCJ_AsuranceApplication/ClaimsHistory/src/main/resources/ClaimHistory.wsdl",
...
public class ServiceProvider extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJ_MAY16/Develop/Repository/BCJ_AsuranceApplication/BCJ_AsuranceApplication/ClaimsHistory/src/main/resources/ClaimHistory.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceProvider.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJ_MAY16/Develop/Repository/BCJ_AsuranceApplication/BCJ_AsuranceApplication/ClaimsHistory/src/main/resources/ClaimHistory.wsdl");
        }
        WSDL_LOCATION = url;
    }
