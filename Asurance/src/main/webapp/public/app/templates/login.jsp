				...
				<fieldset>
					...
					<span class="button-checkbox">
						<button type="button" class="btn" data-color="info">Remember
							Me</button> <input type="checkbox" name="rememberMe" id="remember_me"
						checked="checked" class="hidden"> <a href=""
						class="btn btn-link pull-right">Forgot Password?</a>
					</span>
					<%
						if (failure != null) {
					%><div id="wrongCredential" style="color: red"><%=failure%></div>
					<%
						}
						session.invalidate();
					%>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							...
							<input type="submit" class="btn btn-lg btn-success btn-block"
								value="Submit" onclick= <%request.setAttribute("Quote", quote); %>>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-6">
