...
<body>
	...
	<div class="container" style="margin-top: 86px;">
		...
		<% FullDetails retrievedQuote = (FullDetails) session.getAttribute("retrievedQuote");
			if(retrievedQuote!=null){%><form method="post" action="saveQuote">
			...
			<label style="font-size: 35px;">Quote for 6 Months</label><br> <label
				...
				name="quoteAmount" style="font-size: 35px;">$${retrievedQuote.getQuote().getQuoteAmount()
			...
			<div>
				...
				<span id="liabilitySelection"
					style="margin-left: 40px; color: grey;">$25k/$50k/$25k</span> <span
					id="lbAmt${quote.getLiability() }" class="liabilityAmount"
				...
				<div class="modal fade" id="myModal3" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>We pay to repair damage to your vehicle caused by a
									driver who doesnât have insurance.</p>
								<br>
								<hr class="style13">
								<span><strong>Coverage</strong></span> <span
									style="color: grey; margin-left: 200px;"><strong>Change
								...
								<div class="radio">
									<label><input type="radio" name="optradio"
										value="No Coverage" id="unInsuredNoCoverage">No
										coverage</label> <span class="unInsuredMotoristOption"
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="radio">
									<label><input type="radio" name="optradio"
										value="$1000 deductible" id="1000coll">$1000
										deductible</label> <span style="margin-left: 240px;"
										class="collOption">+$155</span>
								</div>
								...
								<div class="radio">
									<label><input type="radio" name="optradio"
										value="$2000 deductible" id="2000coll">$2000
										deductible</label> <span style="margin-left: 240px;"
										class="collOption">+$105</span>
								</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="radio">
									<label><input type="radio" name="optradio"
										value="No Coverage" id="noRentalCoverage">No coverage</label>
									<span style="margin-left: 240px;" class="rentOption">Current</span>
								</div>
